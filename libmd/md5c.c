...
#endif
#ifdef __FreeBSD__
__FBSDID("$FreeBSD: src/lib/libmd/md5c.c,v 1.17.10.1.6.1 2010/12/21 17:09:25 kensmith Exp $");
#endif
...
#define Bswap(x)  ((ROR((x), 8) & 0xFF00FF00) \
                     | (ROL((x), 8) & 0x00FF00FF))
#define htole32(x) Bswap(x)
#define le32toh(x) Bswap(x)
