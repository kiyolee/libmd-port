...
#endif
#ifdef __FreeBSD__
__FBSDID("$FreeBSD: release/8.2.0/lib/libmd/md2c.c 154479 2006-01-17 15:35:57Z phk $");
#endif
 ...
 */
MD2_API
void MD2Update (MD2_CTX *context, const void *in, unsigned int inputLen)
{
...
/* MD2 padding.
 */
static void MD2Pad (MD2_CTX *context)
{
